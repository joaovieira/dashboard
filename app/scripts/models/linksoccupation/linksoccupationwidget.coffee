...
###
Backbone Model of the Links Occupation widget. It inherits the base functionalities of the Widget 
...
class dashboard.Models.LinksOccupationWidget extends dashboard.Models.Widget
  ...
  ###
  Calculate average occupation from every input in inputs collection using the
